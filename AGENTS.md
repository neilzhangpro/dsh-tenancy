...
This project is indexed by GitNexus as **dsh-tenancy** (484 symbols, 1182 relationships, 23 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/dsh-tenancy/context` | Codebase overview, check index freshness |
| `gitnexus://repo/dsh-tenancy/clusters` | All functional areas |
| `gitnexus://repo/dsh-tenancy/processes` | All execution flows |
| `gitnexus://repo/dsh-tenancy/process/{name}` | Step-by-step execution trace |
